...
class KPISummary(BaseModel):
    ...
    idle_inventory: Optional[float] = Field(None, description="Average idle inventory count")
    idle_inventory_pct: Optional[float] = Field(None, description="Average idle inventory as percentage of capacity")
